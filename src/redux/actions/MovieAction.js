 ...
 function getMovies() {
    return async( dispatch) => {
        try {
            ...
            const popularMoiveApi = api.get(`/tv/top_rated?api_key=${API_KEY}&language=en-US&page=1`)
            const topRatedApi = api.get(`/tv/popular?api_key=${API_KEY}&language=en-US&page=1`)
